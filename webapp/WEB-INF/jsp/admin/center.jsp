...
<body>
  ...
  <div class="container" id="crop-avatar">
	<p id="ID" hidden>${ID}</p>
    <!-- Current avatar -->
    <div style="margin:5% 5% 5% 10%;display: inline-block;height:300px;width:20%;text-align:center">
  ...
  var ID = $("#ID").text();
	$.ajax(
	{
		...
		success : function(data) 
		{
			if (data.flag == "1") 
			{
				$("#info").html("当前用户:"+data.res.userID+"&nbsp;&nbsp;&nbsp;"+data.res.role); 
	...
	function list()
	{
		window.location.href="${ctx}/admin/list/"+ID;
	}
