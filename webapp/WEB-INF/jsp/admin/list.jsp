...
<body>
	...
	{
		return '<a href="${ctx}/admin/user/'+ row['userID'] +'">'+ row['author'] +'</a>';
	}
	
	function articleFormatter(value, row, index)
	{
		return '<a href="${ctx}/admin/article/'+ row['articleID'] +'">'+row['title']+'</a>';
	}
	
	function operateFormatter(value, row, index) {//赋予的参数
	    return [
			'<span>'+
			'<a href="${ctx}/admin/update/'+ row['articleID'] +'" class="button glyphicon glyphicon-edit">Edit</a>'+
	...
	function deleteArticle(articleID,title)
	{
		...
		{
			type : 'post',
			url : '${ctx}/admin/deleteArticleByIDAjax',
			dataType : 'json',
			data : 
			{
				articleID : articleID,
