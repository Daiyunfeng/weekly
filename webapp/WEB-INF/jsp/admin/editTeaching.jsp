...
<body>
	...
	<div class="row" style="margin:0 40px;">
		...
		<div style="text-align:center;">
			<input type="text" id="content" placeholder="添加教学信息">
		...
		<c:forEach var="i" items="${applicationScope.teachings}" begin="0" end="${applicationScope.teachingsNumber}">
			<div class="col-md-12 col-xs-12" style="margin:15px 0 0 40px">
				<p style="display:inline-block;font-size:18px;">${i.content}</p>
				<button style="margin-left:10%;display:inline-block" class="btn btn-danger btn-sm" onclick="deleteTeaching(${i.ID},'${i.content}')">删除</button>
...
<script type="text/javascript">
	...
	function deleteTeaching(id,content)
	{
		...
		{
			type : 'post',
			url : '${ctx}/admin/deleteTeachingAjax',
			dataType : 'json',
			data : 
			{
				teachingID : id,
	...
	function update(id,content)
	{
		...
		{
			type : 'post',
			url : '${ctx}/admin/updateTeachingAjax',
			dataType : 'json',
			data : 
			{
				ID : id,
