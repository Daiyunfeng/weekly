...
<body>
	<div class="wrap-body">
		<jsp:include page="/tourist/nav"></jsp:include>
		...
		<div class='container-fluid'>		
			<div class="span2  col-xs-12 col-sm-3 col-md-2">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li id="photos"><a href="#" onclick="show('photos')">风采</a></li>
                    <li id="people"><a href="#" onclick="show('people')">成员</a></li>
                </ul>
            </div>
            <div class="col-xs-12 col-sm-9 col-md-10">
                <div class="home col-xs-12 col-sm-9 col-md-10" >
                    <jsp:include page="/include/home"></jsp:include>
                </div>
                <div class="research col-xs-12 col-sm-9 col-md-10 hidden" >
                    <jsp:include page="/include/research"></jsp:include>
                </div>
                <div class="publications col-xs-12 col-sm-9 col-md-10 hidden" >
                    <jsp:include page="/include/publications"></jsp:include>
                </div>
                <div class="teaching col-xs-12 col-sm-9 col-md-10 hidden" >
                    <jsp:include page="/include/teaching"></jsp:include>
                </div>
                <div class="photos col-xs-12 col-sm-9 col-md-10 hidden" >
                    <jsp:include page="/include/photos"></jsp:include>
                </div>
                <div class="people col-xs-12 col-sm-9 col-md-10 hidden" >
